			...
			<aside className="w-64 bg-white h-screen flex flex-col">
				...
				<ul className="flex flex-col justify-between items-start font-mono">
					<div className="flex justify-between gap-2 items-center cursor-pointer p-4 ml-2 ">
						<HomeIcon className="text-black w-5 h-5 " />
						<li className="text-xl text-black">Dashboard</li>
					</div>
					<div className="flex justify-between gap-2 items-center cursor-pointer p-4 ml-2">
						<ArrowPathIcon className="w-5 h-5 text-black" />
						<li className=" text-xl text-black">Pending Posts</li>
					</div>
					<div className="flex justify-between gap-2 items-center cursor-pointer p-4 ml-2">
						<HiDocumentText className="text-black w-5 h-5" />
						<li className="text-black text-xl">Active Posts</li>
					</div>
					<div className="flex justify-between gap-2 items-center cursor-pointer p-4 ml-2">
						<HiCollection className="w-5 h-5 " />
						<li className="text-black text-xl">Manage Posts</li>
					</div>
					<div className="flex justify-between gap-2 items-center cursor-pointer p-4 ml-2">
						<ArrowPathIcon className="w-5 h-5 " />
						<li className="text-black text-xl">Manage Users</li>
					</div>
				</ul>
			</aside>
		</div>
